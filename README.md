...
- 역할군별 색유리 8페이지 상자 GUI 상점, 시작 아이템 12종, 장화·강화 장화 16종
...
- LoL식 물리·마법 피해, 방어력·마법 저항력, 고정/비율 관통력 공통 계산
- 6칸 가상 장비 인벤토리, 8개 상점 탭, 70% 판매, GUI 스킬 포인트 투자
- 처치 골드·경험치, 1~18 레벨업, MATCH 자연 골드, 아이템 체력 재생
