...
생성 파일: `build/libs/league-of-minecraft-0.15.0.jar`
...
```text
/lol champion darius|yone|malphite
...
투명 와드는 최대 2회 충전되고 한 플레이어가 동시에 유지할 수 있는 활성 와드도 2개입니다.
소모한 충전은 90초마다 하나씩 회복되며 M 인벤토리에서 현재 충전 수와 다음 충전 시간을 확인합니다.

진행 중인 MATCH에서는 상점이 아군 기지 반경 12블록 안에서만 열립니다. 챔피언 처치자는
300골드/300XP를, 처치 전 10초 안에 피해를 준 아군은 150골드/150XP를 받습니다.
